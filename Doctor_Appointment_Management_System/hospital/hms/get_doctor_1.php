...
if(!empty($_POST["specilizationid"]) && !empty($_POST["city"])) 
{

 $sql=mysqli_query($con,"select doctorName,id from doctors where specilization='".$_POST['specilizationid']."' AND location='".$_POST['city']."'
");?>
