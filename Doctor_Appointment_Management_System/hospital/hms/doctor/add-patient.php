...
<input type="text" name="patname" class="form-control"  placeholder="Enter Patient Name" required="true" value="<?php echo $row['fullName'] ?>">
</div>
<div class="form-group">
<label for="fess">
 Patient Contact no
</label>
<input type="text" name="patcontact" class="form-control"  placeholder="Enter Patient Contact no" required="true" maxlength="10" pattern="[0-9]+" value="<?php echo $row['contact'] ?>">
</div>
<div class="form-group">
<label for="fess">
Patient Email
</label>
<input type="email" id="patemail" name="patemail" class="form-control"  placeholder="Enter Patient Email id" required="true" onBlur="userAvailability()" value="<?php echo $row['email'] ?>">
...
<input type="radio" id="rg-female" name="gender" value="female" <?php if($row['gender']== 'female') echo "
checked";?>>
<label for="rg-female">
Female
</label>
<input type="radio" id="rg-male" name="gender" value="male" <?php if($row['gender']== 'male') echo "
checked";?>>
<label for="rg-male">
Male
</label>
